...
public class CardDisplay : MonoBehaviour
{
    ...
    private void OnMouseUp()
    {
        ...
        {
            //적에게 공격 효과 적용
            CharacterState enemyStats = hit.collider.GetComponent<CharacterState>();
        ...
        {
            CharacterState playerStats = hit.collider.GetComponent<CharacterState>();
        ...
        else
        {
            ...
            //카드 사용 시 마나 소모 (카드가 성곡적으로 사용된 후 추가)
